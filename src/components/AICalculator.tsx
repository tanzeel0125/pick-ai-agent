          ...
          <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50">
            <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
              ...
              <DrawerContent className="max-h-[85vh] bg-[#171717] border-gray-600">
                ...
                <div className="px-4 pb-6 overflow-y-auto bg-neutral-900">
                  {recommendations.length > 0 ? <div className="space-y-4">
      ...
      <div className="bg-white py-6 lg:py-8 mb-40 lg:mb-0">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="flex flex-col items-center gap-4">
            ...
            <Button asChild size="lg" className="bg-[#25D366] hover:bg-[#20BA5A] text-white font-bold px-6 py-3 rounded-full w-auto h-auto">
              <a href="https://wa.me/19208286711?text=I%20want%20to%20build%20an%20app" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
                ...
                <span className="text-base">Let's Chat on WhatsApp</span>
              </a>
            </Button>
          </div>
        </div>
